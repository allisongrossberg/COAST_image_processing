...
data_folder = "/Volumes/Extreme Pro/Image_Analysis_Ouput_3_18_24_COAST_HA_40x_TLR_Exp_Pooled_ADEs_February_3_24_New_COV_Images_Old_Images/"
merged_folder = "/Volumes/Extreme Pro/Image_Analysis_Merged_Files_3_18_24_COAST_HA_40x_TLR_Exp_Pooled_ADEs_February_3_24_New_COV_Images_Old_Images/"
...
dapi_duplicate_df.to_csv(os.path.join(merged_folder, "dapi_duplicate_df.csv"))
...
gfap_duplicate_df.to_csv(os.path.join(merged_folder, "gfap_duplicate_df.csv"))

mfi_dfs = []
for file in all_mfi_list:
    df = pd.read_csv(data_folder + file)
...
mfi_df.to_csv(os.path.join(merged_folder, "mfi_df.csv"))
